...
public final class FragmentAcademicsBinding implements ViewBinding {
  ...
  @NonNull
  public static FragmentAcademicsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentAcademicsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_academics, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentAcademicsBinding bind(@NonNull View rootView) {
