...
public final class FragmentServicesBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView serviceRecycleView;

  private FragmentServicesBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView serviceRecycleView) {
    this.rootView = rootView;
    this.serviceRecycleView = serviceRecycleView;
  }
  ...
  public static FragmentServicesBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.service_recycle_view;
      RecyclerView serviceRecycleView = ViewBindings.findChildViewById(rootView, id);
      if (serviceRecycleView == null) {
        break missingId;
      }

      return new FragmentServicesBinding((ConstraintLayout) rootView, serviceRecycleView);
    }
